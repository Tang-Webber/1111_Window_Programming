    ...
    public partial class Form1 : Form
    {
        ...
        public void SetPicture(Button B)
        {
            if (B.Name == "0" || B.Name == "8")
                B.Image = hw4_2.Properties.Resources._08;
            if (B.Name == "1" || B.Name == "9")
                B.Image = hw4_2.Properties.Resources._01;
            if (B.Name == "2" || B.Name == "10")
                B.Image = hw4_2.Properties.Resources._02;
            if (B.Name == "3" || B.Name == "11")
                B.Image = hw4_2.Properties.Resources._03;
            if (B.Name == "4" || B.Name == "12")
                B.Image = hw4_2.Properties.Resources._04;
            if (B.Name == "5" || B.Name == "13")
                B.Image = hw4_2.Properties.Resources._05;
            if (B.Name == "6" || B.Name == "14")
                B.Image = hw4_2.Properties.Resources._06;
            if (B.Name == "7" || B.Name == "15")
                B.Image = hw4_2.Properties.Resources._07;
        }
        ...
        private void start_Click(object sender, EventArgs e)
        {
            ...
            if(username != "" && username.Length >= 3 && username.Length <= 10)
            {
                ...
                for (int i = 0; i < 16; i++)
                {
                    ...
                    card[Index].Image = hw4_2.Properties.Resources.card;
                    repeat[Index] = 1;
                }
            }
            else if(username == "")
        ...
        {
            card[openIndex].Image = hw4_2.Properties.Resources.card;
            card[pairIndex].Image = hw4_2.Properties.Resources.card;
            pairing = true;
            openIndex = 16;
            pairIndex = 16;
            cont.Enabled = false;
